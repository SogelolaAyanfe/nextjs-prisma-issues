...
export default function EditPostPage() {
    ...
    return (
        <form
            className="flex flex-col items-center justify-center gap-[30px] p-9 pt-[90px]"
            onSubmit={e => {
                e.preventDefault()
        ...
        >
            <div className="flex w-full max-w-[900px] flex-col items-center justify-center gap-[20px] pt-[40px] lg:min-w-[400px]">
                <input
                    ...
                    placeholder="Title"
                    value={title}
                    className="h-[45px] w-full max-w-[900px] rounded-md border-[2px] border-black pl-[5px] placeholder-black sm:max-w-[500px] sm:min-w-[290px] lg:min-w-[400px]"
                ...
                <button
                    ...
                    className="w-full max-w-[300px] self-center rounded-lg bg-black px-4 py-2 text-white hover:bg-neutral-600 sm:w-[200px] lg:w-[200px]"
                >
